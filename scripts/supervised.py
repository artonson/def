...
def pseudoLap1(y_pred, y_true, bce_weight=.5, reduction='mean',**kwargs):
    ...
    l1_loss = l1(cpoints_pred, cpoints_true)
    bce_loss = bce(logits_pred, logits_true)
    endpoint_loss = pseudoLap1_weight(l1_loss)
    if 'none' == reduction:
