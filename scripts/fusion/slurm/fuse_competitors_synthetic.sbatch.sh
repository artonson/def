...
mkdir -p ${OUTPUT_PATH_GLOBAL}/${PRED_KEY}
...
singularity exec \
  ...
  "${SIMAGE_FILENAME}" \
      ...
      python3 ${COMBINE_SCRIPT} \\
        ...
        --output-dir ${OUTPUT_PATH_GLOBAL}/${PRED_KEY} \\
