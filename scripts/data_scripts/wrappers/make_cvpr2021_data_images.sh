...
export DATATYPE=images

# codebase configuration
export PROJECT_ROOT=/trinity/home/a.artemov/repos/sharp_features
export GENERATE_DATA_SCRIPT=${PROJECT_ROOT}/scripts/data_scripts/slurm/make_images.sbatch.sh
export SHUFFLE_SCRIPT=${PROJECT_ROOT}/scripts/data_scripts/slurm/shuffle_images.sbatch.sh

# job configuration
# export CONFIG_LIST="high_res.json"
export CONFIG_LIST="med_res.json low_res.json"
