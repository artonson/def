...
#SBATCH --job-name=sharpf-whole-images
#SBATCH --output=/trinity/home/a.artemov/tmp/sharpf_images_whole/%A_%a.out
#SBATCH --error=/trinity/home/a.artemov/tmp/sharpf_images_whole/%A_%a.err
#SBATCH --array=1-10
...
MAKE_DATA_SCRIPT="${CODE_PATH_CONTAINER}/scripts/data_scripts/generate_fused_depthmap_data.py"
