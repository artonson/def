...
# INSTANCE_LIST_FILENAME=${LOGDIR}/whole_models_inference_final/ct_scans.txt
...
run_combine() {
    ...
    output_filename=${BASE_OUTPUT_DIR}/${res}/${noise}/${model}/${task}/abc_0050_${instance_name}__adv60__min.hdf5
