...
def main(options):
    ...
    file_path = options.true_filename
    ...
    imaging = RaycastingImaging(
        resolution_image=gt_images[0].shape,
        resolution_3d=THRESH_EDGE,
        projection=None,
...
if __name__ == '__main__':
    ...
    # read triplets (input_path, pred_path, out_path) from listing of files `files-list`
    pool_args = []
    ...
    r = list(tqdm(pool.imap(main, pool_options), total=len(pool_options)))
