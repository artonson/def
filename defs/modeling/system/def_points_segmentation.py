...
class DEFPointsSegmentation(LightningModule):
    ...
    def _shared_eval_step(self, batch, batch_idx: int, dataloader_idx: Optional[int], partition: str):
        ...
        self.mrecall_pos[partition][dataloader_idx].update(result['preds_sharp'].bool(), batch['target_sharp'].bool())
        self.mrecall_neg[partition][dataloader_idx].update(result['preds_sharp'].bool(), batch['target_sharp'].bool())
