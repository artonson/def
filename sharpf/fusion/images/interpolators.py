...
class MultiViewPredictionsInterpolator(MultiViewInterpolatorBase):
    def __init__(
            ...
            boundary_width_to_remove: int = 0,
            verbose: bool = False,
    ):
        super().__init__()
        self.n_jobs = n_jobs
        ...
        self.boundary_width_to_remove = boundary_width_to_remove
    ...
    def __call__(
        ...
        interp_params = {
            ...
            'boundary_width_to_remove': self.boundary_width_to_remove,
    ...
    def from_config(cls, config: Mapping):
        return cls(
            ...
            boundary_width_to_remove=config['boundary_width_to_remove'],
