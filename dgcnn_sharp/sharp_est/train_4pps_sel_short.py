...
parser.add_argument('--model', default='dgcnn_sharp', help='Model name [default: dgcnn_sharp]')
...
TRAIN_DATASET = modelnet_h5_dataset.ModelNetH5Dataset(os.path.join(BASE_DIR, 'data/4pps_sel_short/train_files.txt'), batch_size=BATCH_SIZE, npoints=NUM_POINT, shuffle=True)
TEST_DATASET = modelnet_h5_dataset.ModelNetH5Dataset(os.path.join(BASE_DIR, 'data/4pps_sel_short/val_files.txt'), batch_size=BATCH_SIZE, npoints=NUM_POINT, shuffle=False)
